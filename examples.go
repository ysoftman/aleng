...
나만 모르게 두지 마세요. 무슨일이에요?
He is completely in the dark about what happed.
그는 무슨일이 있었는지 하나도 모르고 있어.
--
On a lighter note, i got that raise.
여담이지만, 그 봉급 인상받았어.
On a lighter note, we ordered pizza.
여담이지만, 우리 피자 시켰어.
--
On the bright side, no one was hurts.
긍정적으로 보면 아무도 다치지 않았어.
--
Adventure may hurt you but monotony will kill you
모험이 널 다치게할수는 있지만 단조로움은 널 죽일거야.
--
Back in elementary school, I was really short.
초등학교때 난 정말 키가 작았어.
--
Got it?
알겠어?
...
저 따라가도 돼요?
--
This is my go-to song when I want to listen to some music.
이건 음악을 듣고 싶을때 항상 듣는 노래에요.
Do you have a go-to dinner recipe?
저녁식사로 항상 만드는 요리가 있나요?
--
Oh, I am feeling nauseous.
아, 나 속이 메스꺼워.
...
와줘서 고마워.
--
This project is extremely import, so we can't cut any corners.
이 프로젝트는 아주 중요해서 대충할 수 없어요.
They were cutting corners to save some money.
그들은 돈을 아끼려고 절차를 무시하고 있다.
--
One way or another, we will find out the truth.
어쨌던간에 우리는진실을 찾아낼거야.
I will finish the job, one way or another.
어떻게든 일을 끝낼 거야.
--
...
저도 잘 몰라요.(저도 모르기는 마찬가지에요.)
Your guess is as good as mine as to why she never showd up.
그녀가 왜 나타자니 않았는지 저도 잘 몰라요.
--
...
이거 점점 좋아지네요.
--
I sure hope the rumor turns out to be true.
그 소문이 사실이 되길 바래.
--
It seems like you will get promoted soon.
니가 곧 승진할것 같애.
--
I was about to
막 하려던 참이었어.
...
집에 너무 많은 잡동사니로 스트레스 받아.
From now on, I'm going to minimize the stuff around me.
이제부터는 주위 물건들을 최소로 줄일거야.
Sounds like you mean it this time.
말하는것 보니까 이번에 진심인것 같네.
--
What are those for?
저것들은 어디에 쓰는 거에요?
...
나는 단호하게 말했어, "해변에는 학교 끝나고 가"
I suppose they won't invite you out and more.
아마 이제 더이상 너한테 어디 가자고 하지 않을거야.
--
...
이것에 대해 당신의 의견을 알고 싶습니다.
I would like to know your opinion on something.
물어보고 싶은게 있어요.
Could you explain in more detail?
좀 더 자세히 설명해주세요?
Could you elaborate / Care to elaborate
자세히 말해주겠어요?
Could you tell me more about it?
자세히 말해주겠어요?
--
We have gotten off point
우리 요점에서 벗어났어요.
--
Congratulations on your promotions, Armen.
아르멘 승진 축하해.
...
이제 열심히 일해야 할것 같아.
There is so much to look forward do.
기대할 일이 아주 많아.
--
I connect with her.
그녀랑 친해.
...
그건 여기 없는것 같아요.
I will get in touch with other library branch.
제가 다른 도서관에 연락해보겠습니다.
--
How many seconds should I give it?
얼마나 걸리니?
Just take your time.
천천히 해.
--
...
100% 확신해요.
--
What do you say to a week in London.
런던에서 일주일 어때?
--
What do you mean it's not ready?
준비가 안됐다는게 무슨 의미인가요?
Sorry, I made a mistake with the date, so I counln't prepare
죄송해요, 날짜를 착각해서 준비를 못했어요.
--
That's too corny.
너무 촌스러워.
Okay, I apologize.
...
서비스에요.
--
I will come over to your house today.
오늘 너의 집으로 건너갈께.
--
...
당신의 제안을 잘 생각해보겠습니다.
I will check over tyou paper.
당신의 논문을 잘 검토하겠습니다.
pull over your car / pull up your car.
차를 세우세요.
pull over your car to the corners.
당신의 차를 코너 쪽으로 세우세요.
--
...
비행기 태우지마.
--
Though I studied english hard, I still didn't pass the test.
열심히 영어 공부를 했지만 시험에 통과하지 못했다.
Although I studied english hard, I still didn't pass the test.
열심히 영어 공부를 했지만 시험에 통과하지 못했다.(격식있는 표현)
Even though I studied english hard, I still didn't pass the test.
열심히 영어 공부를 했지만 시험에 통과하지 못했다.(대조 의미를 좀더 강조한 표현)
In spite of studying english very hard, I still didn't pass the test.
열심히 영어 공부를 했지만 시험에 통과하지 못했다.(In spite of + 명사)
Despite studying english very hard, I still didn't pass the test.
열심히 영어 공부를 했지만 시험에 통과하지 못했다.(Despite + 명사)
--
Since I had no money, I couldn't take a trip.
돈이 없어서 여행을 가지 못했어.
Since I was busy, I couldn't visit my parents.
바빠서 부모님을 뵙지 못했어.
--
I am off today.
나 오늘 쉰다.
...
5분 후에 보자.
See you within 5 minutes.
5분 이내에 보자.
--
I prefer orange.
난 오렌지를 선호한다.
I prefer orange to apple.
난 사과보다 오렌지를 선호한다.
--
The book was so interesting that I read it at one sitting.
그책은 너무 재밌어서 한번에 다 읽었어.(so..that 너무 ..해서 ..하다)
--
I want to eat out today.
나 오늘 외식하고 싶어.
Let's go out to eat dinner.
저녁 밖에서 먹자.
He will go out with her.
그는 그녀와 데이트할거야.
--
...
집까지 태워 줄래?
--
What is the best way to (go to) your office by bus.
너의 사무실에 버스로 가는 가장 좋은 방법은 뭐니?
--
...
여긴 무슨 일로 왔어?
What happened to you in the class yesterday?
어제 수업에서 무슨일 있었니?
--
...
어떤 종류의 음악을 좋아하나요?
--
What time is the next flight to seoul?
다음 서울행 비행기 시간은 언제 인가요?
--
How old is this building?
이 건물은 얼마나 오래됐나요?
How many years have you been live in Korea?
한국에 산지는 몇년 됐나요?
...
그녀는 얼마나 자주 쇼핑하니?
--
How come you visited her place?
어떻게(왜) 그녀 집을 방문했니?
--
My whole body aches.
온몸이 쑤신다.
...
거기서 너를 보면 좋겠어요.(아직 일어나지 않는일은 to V)
It was nice seeing you there.
거기서 너를 봐서 좋았어요.(벌어진일은 V+ing)
--
Tardy agin.
또 지각이구나.
I'm hangry.
...
좀 참고 견뎌줘(기다려줘)
--
I am just trying to teach you how to do these things.
난 그저 이거 어떻게 하는지 좀 알려주려고 하는거야.
I don't want to be the one who always complains and whines.
난 불평하고 징징대는 사람이 되고 싶지 않아.
I don't even know how I made it here.
내가 어떻게 여기에 왔는지 모르겠어.
--
Loosen up and light up.
긴장풀고 기운내.
--
He is a man who can run fast.(He is a man. He can run fast.)
그는 빨리 달릴 수 있는 사람이다.
He is a man whose legs are very long.(He is a man. His legs are very long.)
그는 다리가 매우 긴 사람이다.
He is a man whom people like.(He is a man. People like him.)
그는 사람이들이 매우 좋아하는 사람이다.
She likes the piano which made by Bill.(She likes the piano. The piano made by Bill.)
그녀는 빌이 만든 피아노를 좋아한다.
She likes the piano the color of which is brown.(She likes the piano. The color of piano is brown.)
그녀는 갈색 피아노를 좋아하다.
She likes the piano which people like.(She likes the piano. People like the piano.)
그녀는 사람들이 좋아하는 피아노를 좋아한다.
--
I had to rush a decision.
난 결정을 서둘러야만 했다.
--
...
Can I have a monet?
시간 있나요?
Got a second(or minute)?
시간 있니?
--
I should be there by 10.
10시까지 도착할거 같아.
You should have heard by now that I am gone.
넌 지금쯤 내가 없어졌다는걸 들었을 거야.
...
난 운전할때 음악 듣는걸 좋아한다.(두사건이 관련 없을때 while)
The overhead bin opened up as the plane took off.
비행기가 이륙했을때 윗 짐칸 문이 열렸다.(예상치 못한 사건이 발생시 as)
--
Something came up.
일이 생겼어.
--
...
많은 분들이 궁금해 하실것 같아요.
--
I am coming down with the cold.
감기 기운이 있는것 같다.
I think my sister gave me her cold.
누나한테 감기 옳은것 같아.
--
How is it going?
어떻게 지내?
...
핸드폰 진동으로 해줄래?
--
Come again? I counld't hear what you said.
다시 말해줄래? 뭐라고 했는지 듣지 못했어.
--
